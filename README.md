About mercantile-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mercantile-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3080&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mercantile-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mercantile` can be installed with `conda`:
...
```
mamba install mercantile
```

It is possible to list all of the versions of `mercantile` available on your platform with `conda`:
...
```
mamba search mercantile --channel conda-forge
```
...
mamba repoquery search mercantile --channel conda-forge

# List packages depending on `mercantile`:
mamba repoquery whoneeds mercantile --channel conda-forge

# List dependencies of `mercantile`:
mamba repoquery depends mercantile --channel conda-forge
```
